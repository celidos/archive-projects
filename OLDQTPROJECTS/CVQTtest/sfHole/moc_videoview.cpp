...
static const char qt_meta_stringdata_VideoView[] = {
    "VideoView\0"
};
...
const QMetaObjectExtraData VideoView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VideoView::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_VideoView,
      qt_meta_data_VideoView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoView))
